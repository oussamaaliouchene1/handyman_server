                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                {{ Form::text('mobile_no',old('mobile_no'),['placeholder' => trans('messages.mobile_no'),'pattern' => '^[0-9+\- ]{1,15}$','class' =>'form-control mobile_no','required']) }}
                                <small class="help-block with-errors text-danger" id="mobile_no_err"></small>
                            </div>
                            <div class="form-group col-md-4">
