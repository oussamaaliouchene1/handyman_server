...
use App\Http\Controllers\PaymentAcceptController;
...
Route::post('/accept_payment',[PaymentAcceptController::class,'accept_payment']);
// Route::post('/handyman/list',[PaymentRejectController::class,'reject_payment'])->name('handyman.reject');
